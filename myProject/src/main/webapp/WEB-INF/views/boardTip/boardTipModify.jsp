  	...
  	<form:form commandName="boardFree" action="modify.do"
		...
		<ul style="margin-top:20px">
			...
			<li>
				...
				<form:textarea path="free_content" id="free_content" cols="45" rows="15"/>
			...
			<li>
				...
				<c:if test="${!empty boardFree.free_filename}">
					...
					<div class="align-center">
						<img src="imageView.do?free_num=${boardFree.free_num}" name="free_mfile" id="free_mfile" style="max-width:350px; max-height:350px;">
					</div>				
				</c:if>	
