      ...
      <form:form id="re_form" action="findExit.do" commandName="memberVO">
         ...
         <div class="form">
            <a><img src="../resources/images/text_result.png"></a>
               <c:if test="${findId.mem_id == null}"><li class="id_result">검색 결과가 없습니다.<br> 입력정보를 다시 확인해주세요.</li></c:if>
               <c:if test="${findId.mem_id != ''}"><li class="id_result">${findId.mem_id}</li></c:if>
            <!-- 로그인 버튼 -->
