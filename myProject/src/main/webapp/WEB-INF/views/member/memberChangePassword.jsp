...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/layout_memberChangePw.css">
  ...
  <div class="container">
    ...
    <form:form id="member_modify-form" action="changePassword.do" commandName="memberVO">
    	<ul>
			...
			<li>
				<form:input type="password" path="now_passwd" placeholder="현재 비밀번호 입력"/>
			</li>
			
			<a><img class="mypage_texts" src="../resources/images/text_modify_pw.png"></a>
			<li>
				<form:input type="password" id="mem_pw" path="mem_pw" placeholder="변경할 비밀번호"/>
			</li>
			
			<a><img class="mypage_texts" src="../resources/images/text_confirm_pw.png"></a>
			<li>
				<input type="password" id="confirm_passwd"  placeholder="변경할 비밀번호 확인"/>
			</li>
