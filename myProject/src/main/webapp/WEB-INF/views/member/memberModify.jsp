  ...
  <div class="container">
    ...
    <form:form id="member_modify-form" action="update.do" commandName="memberVO" >
    	<ul>
			...
			<li>
				<form:input type="text" id="mem_zipcode" path="mem_zipcode" placeholder="${member.mem_zipcode}"/>
			...
			<li>
				<form:input type="text" id="mem_addr1" path="mem_addr1" placeholder="${member.mem_addr1}"/>
			</li>
			
			<a><img class="mypage_texts" src="../resources/images/text_addr2.png"></a>
			<li>
				<form:input type="text" id="mem_addr2" path="mem_addr2" placeholder="${member.mem_addr2}"/>
